...
INSERT INTO book (isbn, titulo, autor, editorial, portada, fecha, fecha_alta, resumen, media_valoracion) VALUES ('1234567890', 'El Señor de los Anillos', 'J.R.R. Tolkien', 'Minotauro', 'https://m.media-amazon.com/images/I/91CZONTFNgL._SY342_.jpg', '1891-06-2', '2023-01-19', 'En la conclusión épica de "El Señor de los Anillos", Frodo y Sam, guiados por Gollum, continúan su peligrosa misión hacia el Monte del Destino para destruir el Anillo Único. Mientras, Aragorn lidera a los Pueblos Libres en la batalla final contra las fuerzas de Sauron en Minas Tirith. Es una lucha desesperada por la libertad y la esperanza, con el destino de la Tierra Media en la balanza. J.R.R. Tolkien cierra su obra maestra con heroísmo, sacrificio y la promesa de paz tras la oscuridad.', 5);
INSERT INTO book_genres (book_isbn, genres) VALUES ('1234567890', 0);

INSERT INTO book (isbn, titulo, autor, editorial, portada, fecha, fecha_alta, media_valoracion) VALUES ('1234567891', 'Guia del autoestopista intergalactico', 'Douglas Adams', 'Anagrama', 'https://quelibroleo.com/images/libros/libro_1384705967.jpg', '1999-06-2', '2024-02-22', 5);
INSERT INTO book_genres (book_isbn, genres) VALUES ('1234567891', 4);

INSERT INTO book (isbn, titulo, autor, editorial, portada, fecha, fecha_alta, media_valoracion) VALUES ('9780307474728', 'Cien anios de soledad', 'Gabriel García Márquez', 'Vintage Español', 'URL_GENÉRICA_DE_PORTADA', '1967-06-05', '2024-02-23', 0);
INSERT INTO book_genres (book_isbn, genres) VALUES ('9780307474728', 0);

INSERT INTO book (isbn, titulo, autor, editorial, portada, fecha, fecha_alta, media_valoracion) VALUES ('9781503290563', 'Orgullo y prejuicio', 'Jane Austen', 'CreateSpace Independent Publishing Platform', 'URL_GENÉRICA_DE_PORTADA', '1813-01-28', '2024-02-23', 0);
INSERT INTO book_genres (book_isbn, genres) VALUES ('9781503290563', 1);

INSERT INTO book (isbn, titulo, autor, editorial, portada, fecha, fecha_alta, media_valoracion) VALUES ('9780060935467', 'Matar a un ruisenioor', 'Harper Lee', 'Harper Perennial Modern Classics', 'URL_GENÉRICA_DE_PORTADA', '1960-07-11', '2024-02-23', 0);
